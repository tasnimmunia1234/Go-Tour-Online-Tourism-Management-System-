...
<head>
    ...
    <link rel="stylesheet" href="asset/offer_package.css">
...
<div class="container" id="container">
    <div class="row">
        ...
        <div class="col" id="col"><a href="grouppackage.php" class="btn "><p>Group Package</p></a></div>
...
if(mysqli_num_rows($select_packages) > 0){
   ...
   while($fetch_package = mysqli_fetch_assoc($select_packages)){
    if($fetch_package["category"]=='Group package'){
?>
