...
<p class="pac_price"><strong><b>Price: </b><?php echo $package['price']; ?>/-</strong></p>
  ...
  <div class="detiles">
  <p class="notice"><strong>Notice:</strong> This is an all-inclusive package 1 person.(if you want to add more person and you want stay extra days bill will be added)</p>
  ...
  <article class="package-include">
                              ...
                              <button class="booking_btn" name="book"><a href="couplepak_booking.php?pak_id=<?php echo $package['pak_id'];?>" class="a_btn">Book Now</a></button>
