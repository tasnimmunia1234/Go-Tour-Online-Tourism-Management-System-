    ...
    <article>
      ...
      <section class="hero" id="home">
        ...
        <h1 style="font-size:50px" class="heading">
                  <span class="span" >INTERATIONAL - PACKAGE</span>
...
if(mysqli_num_rows($select_packages) > 0){
   ...
   while($fetch_package = mysqli_fetch_assoc($select_packages)){
    if($fetch_package["category"]=='International'){
?>
    ...
    <div class="card">
        ...
        <p class="package_name"><i class="fa-solid fa-location-dot"></i> <?php echo $fetch_package['name']; ?></p>
            ...
            <div class="see_btn"><a href="international_details.php?pak_id=<?php echo $fetch_package['pak_id']; ?>" name="add" class="add">See Details</a></button> </div>
        </div>
