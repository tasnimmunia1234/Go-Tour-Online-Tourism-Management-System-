...
if(isset($_POST['add_photo'])){
    ...
    if($insert_query){
       ...
       $message[] = 'Upadate Photo succesfully';
    }else{
 ...
 if(isset($_GET['delete'])){
    ...
    $delete_query= mysqli_query($conn, "DELETE FROM `gallery` WHERE gallery_id = $delete_id");
...
<head>
    ...
    <link rel="stylesheet" href="asset/managegellery.css">
...
<tbody>
         <?php
         $ct=1;
            $select_packages = mysqli_query($conn, "SELECT * FROM `gallery`");
         ...
         <td><?php echo $ct; ?></td>
            ...
            <td>
               <a href="managegallery.php?delete=<?php echo $row['gallery_id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('are your sure you want to delete this?');"> <i  class="fas fa-trash"></i></a>
               <a href="editgallery.php?edit=<?php echo $row['gallery_id']; ?>" class="btn btn-sm btn-info"> <i class="fa-solid fa-pen-to-square"></i></i></a>
            </td>
