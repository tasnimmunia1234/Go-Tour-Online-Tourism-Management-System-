    ...
    <article>
      ...
      <section class="hero" id="home">
        ...
        <h1 style="font-size:50px" class="heading">
                  <span class="span" >COUPLE - PACKAGE</span>
...
?>
    ...
    <div class="card">
        ...
        <p class="package_name"><i class="fa-solid fa-location-dot"></i> <?php echo $fetch_package['name']; ?></p>
            ...
            <div><a href="couplepak_details.php?pak_id=<?php echo $fetch_package['pak_id']; ?>" name="add" class="add">See Details</a></button> </div>
        </div>
