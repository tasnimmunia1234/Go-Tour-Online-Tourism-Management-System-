    ...
    <article>
      ...
      <section class="hero" id="home">
        ...
        <h1 style="font-size:50px" class="heading">
                  <span class="span" >PACKAGE - DETAILS</span>
...
<p class="pac_price"><strong><b>Price: </b><?php echo $package['price']; ?>/-</strong></p>
  ...
  <div class="detiles">
  <p><strong>Notice:</strong> This is an all-inclusive package 1 person.(if you want to add more person and you want stay extra days bill will be added)</p>
