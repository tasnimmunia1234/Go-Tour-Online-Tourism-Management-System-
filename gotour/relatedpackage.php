...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="asset/slide_pak.css">
...
<body>
    <div class="container">
        <h1 class="offer_package">RELATED PACKAGES</h1>
...
<div class="slide">
    ...
    <button class="see_detalis_btn" name="add" ><a href="package_details.php?pak_id=<?php echo $fetch_package['pak_id']; ?>" name="add" class="see_detalis">See Details</a></button>
